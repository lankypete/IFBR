...
new _RevealOnScroll2.default((0, _jquery2.default)('.pricing'), "69%");
new _RevealOnScroll2.default((0, _jquery2.default)('.contact-us'), "69%");
var bannerFader = new _FadingBanner2.default();
...
var MobileMenu = function () {
	function MobileMenu() {
		...
		this.menu = (0, _jquery2.default)('.nav-menu');
		this.events();
	}
...
var FadingBanner = function () {
	function FadingBanner() {
		_classCallCheck(this, FadingBanner);

		this.numOfChildren = (0, _jquery2.default)('.banner__fader > div').length;
		this.fadeChildElements();
	}

	_createClass(FadingBanner, [{
		key: 'fadeChildElements',
		value: function fadeChildElements() {
			var currentDiv = 0,
			    totalDivs = this.numOfChildren;

			function fn() {
				(0, _jquery2.default)('.banner__fader > :nth-child(' + currentDiv + ')').removeClass('banner__info--visible');
				currentDiv++;
				if (currentDiv > totalDivs) currentDiv = 1;
				(0, _jquery2.default)('.banner__fader > :nth-child(' + currentDiv + ')').addClass('banner__info--visible');
			}
			fn();
			setInterval(fn, 3700);
		}
...
var StickyHeader = function () {
	function StickyHeader() {
		...
		this.headerDiv = (0, _jquery2.default)('.site-header');
		this.getStickyHere = (0, _jquery2.default)('.banner__fader');
		this.pageSection = (0, _jquery2.default)('.page-section');
		this.headerLinks = (0, _jquery2.default)('.nav-menu a');
		this.lazyloadElements = (0, _jquery2.default)('.lazyload');
		this.makeSticky();
		this.colourLinks();
				...
				new Waypoint({
					...
					handler: function handler(direction) {
						if (direction == 'down') {
							...
							(0, _jquery2.default)(matchingNavLink).addClass('nav-menu__link--current');
						}
					},
					offset: '18%'
				});
